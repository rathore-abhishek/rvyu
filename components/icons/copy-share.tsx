...
const CopyShare = (props: Props) => {
  return (
    ...
    >
      <path
        opacity="0.4"
        d="M3 9.3C3 6.33015 3 4.84523 4.31802 3.92261C5.63604 3 7.75736 3 12 3C16.2426 3 18.364 3 19.682 3.92261C21 4.84523 21 6.33015 21 9.3V14.7C21 17.6698 21 19.1548 19.682 20.0774C18.364 21 16.2426 21 12 21C7.75736 21 5.63604 21 4.31802 20.0774C3 19.1548 3 17.6698 3 14.7V9.3Z"
        fill="currentColor"
      ></path>
      <path
